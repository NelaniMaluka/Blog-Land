...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String toEmail, String token) {
        ...
        String htmlContent = "<div style='font-family:Arial,sans-serif;color:#333;background:#f9f9f9;max-width:500px;width:100%;margin:auto;'>"
                + "<div style='padding:1px 20px 0 20px'><h2 style='margin:20px 0'>Blog-Land</h2></div>"
                + "<div style='text-align:center;'>"
                + "<img src='" + logoUrl
                + "' alt='Blog Land Logo' style='width:100%;height:auto;display:block;margin-bottom:20px;'/>"
                + "</div>"
